      ...
      if(i < this.state.currentIndex) {
        ...
        return (
          <Animated.View
            ...
            <Animated.View style={{ opacity: this.likeOpacity, position: 'absolute', top: 50, left: 40, zIndex: 1000, transform: [{rotate: '-30deg'}]}}>
              <Text style={{borderWidth: 1, borderColor: 'green', color: 'green',
                fontSize: 32, fontWeight: '800', padding: 10,}}>LIKE</Text>
            </Animated.View>
        ...
        return (
          <Animated.View
            ...
            <Animated.View style={{ opacity: 0, position: 'absolute', top: 50, left: 40, zIndex: 1000, transform: [{ rotate: '-30deg' }] }}>
              <Text style={{
                borderWidth: 1, borderColor: 'green', color: 'green',
                fontSize: 32, fontWeight: '800', padding: 10,
              }}>LIKE</Text>
            </Animated.View>
            <Animated.View style={{ opacity: 0, position: 'absolute', top: 50, right: 40, zIndex: 1000, transform: [{ rotate: '30deg' }] }}>
              <Text style={{
                borderWidth: 1, borderColor: 'red', color: 'red',
                fontSize: 32, fontWeight: '800', padding: 10,
              }}>NOPE</Text>
